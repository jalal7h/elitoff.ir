...
function nb_management_saveEdit(){
	...
	if(!$_POST){
		...
		`seller_cell`='".$_REQUEST['seller_cell']."',
		`seller_website`='".$_REQUEST['seller_website']."',
		`seller_telegram`='".$_REQUEST['seller_telegram']."',
		`seller_instagram`='".$_REQUEST['seller_instagram']."',
